 ...
 * Fichier centralisé pour faciliter les mises à jour.
 */
const projects = [
  {
    id: 1,
  ...
  {
    id: 6,
    title: 'CareCover | Gestion d’Assurance Maladie & IA (Projet de Fin d’Études – Tunisie Telecom)',
    description: "Conception et développement d'une plateforme web moderne dédiée à la gestion d'assurance maladie. Intégration de l'API Gemini (IA) pour l'analyse intelligente et la numérisation des bulletins de soins. Implémentation d'un algorithme de détection de fraude basé sur des règles déterministes (détection de doublons, chevauchements de dates) et statistiques (abus de médicaments, nomadisme médical).",
    technologies: ['React', 'Node.js', 'Express.js', 'MySql (Sequelize)', 'Gemini-AI'],
    images: [
